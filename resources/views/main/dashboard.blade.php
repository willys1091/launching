        ...
        <div
            ...
            <div class="flex-sm-fill">
                ...
                <h2 class="h6 font-w500 text-muted mb-0">
                    Welcome <a class="font-w600" href="javascript:void(0)">{{ucwords(Session('name'))}}</a>, everything
                    looks great.
                </h2>
            </div>
                ...
                <table class="table table-borderless table-striped table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="font-size-sm font-w600 px-2 py-1 rounded  bg-info-light text-info">For
                                    delivery</span>
                            </td>
                            <td class="d-none d-xl-table-cell text-center font-size-sm">
                                <a class="font-w600" href="javascript:void(0)">5</a>
