            ...
            <table class="table table-bordered table-striped dt-responsive table-vcenter js-dataTable" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-sm-table-cell font-size-sm">{{$p->name}}</td>
                        <td class="text-center">
                            <a onClick='showM("{{url('province/'.$p->id.'/edit')}}");return false' type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fas fa-fw fa-pencil-alt"></i></a>
                        </td>
                    </tr>   
                    @php $x++ @endphp
                    @endforeach
