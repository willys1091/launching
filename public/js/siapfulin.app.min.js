/*!
 * Siapfulin - v1.0.0
 * @author siapfulin - https://siapfulin.com
 * Copyright (c) 2020
 */
! function () {
    "use strict";
    ...
    var o, n = !1,
        r = function () {
            ...
            return r = e, null, (l = [{
                ...
                key: "maskedInputs",
                value: function () {
                    jQuery(".js-masked-date:not(.js-masked-enabled)").mask("99/99/9999"), jQuery(".js-masked-date-dash:not(.js-masked-enabled)").mask("99-99-9999"), jQuery(".js-masked-phone:not(.js-masked-enabled)").mask("(999) 999-9999"), jQuery(".js-masked-phone-ext:not(.js-masked-enabled)").mask("(999) 999-9999? x99999"), jQuery(".js-masked-tax:not(.js-masked-enabled)").mask("99.999.999.9-999.999"),jQuery(".js-masked-taxid:not(.js-masked-enabled)").mask("99-9999999"), jQuery(".js-masked-npwp:not(.js-masked-enabled)").mask("99.999.999.9-999.999"), jQuery(".js-masked-zip:not(.js-masked-enabled)").mask("99999"), jQuery(".js-masked-ssn:not(.js-masked-enabled)").mask("999-99-9999"), jQuery(".js-masked-pkey:not(.js-masked-enabled)").mask("a*-999-a999"), jQuery(".js-masked-time:not(.js-masked-enabled)").mask("99:99"), jQuery(".js-masked-date").add(".js-masked-date-dash").add(".js-masked-phone").add(".js-masked-phone-ext").add(".js-masked-taxid").add(".js-masked-ssn").add(".js-masked-pkey").add(".js-masked-time").addClass("js-masked-enabled")
                }
            }, {
                key: "select2",
                value: function () {
                    ...
                    jQuery(".js-sparkline:not(.js-sparkline-enabled)").each((function (a, t) {
                        var r = jQuery(t),
                            ...
                            s = {
                                ...
                                pie: function () {
                                    i.type = l, i.sliceColors = ["#fadb7d", "#faad7d", "#75b0eb", "#abe37d"], i.highlightLighten = r.data("highlight-lighten") || 1.1, i.tooltipFormat = "{{prefix}}{{value}}{{suffix}}"
                                },
                                tristate: function () {
            ...
            value: function () {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', (function (o) {
                    ...
                    var n = jQuery(o.currentTarget),
                        r = n.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').addClass("active"), a.updateTheme(e, r), e = jQuery("#css-theme"), t && Cookies.set("oneuiThemeName", r, {
                        expires: 7
                    }), n.trigger("blur")
                }))
            }
